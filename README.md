...
![Typing SVG](https://readme-typing-svg.herokuapp.com/?font=Fira+Code&size=24&duration=3000&pause=1000&color=00D4AA&center=true&vCenter=true&width=600&lines=Junior+Backend+Developer+%F0%9F%8C%B1;Aprendiendo+y+creciendo+cada+día;En+busca+de+mi+primera+oportunidad)

## 🚀 Sobre mí

Soy **Alejandro Tacoronte González** ([@alejandrotg-code](https://github.com/alejandrotg-code)), un desarrollador backend junior apasionado por aprender y crear soluciones web. Estoy comenzando mi camino en el desarrollo y me encanta trabajar del lado del servidor con APIs y bases de datos.
...
const alejandro = {
    ...
    estado: "Buscando mi primera oportunidad laboral",
...
- 📖 **Documentación**: Aprendiendo a leer y escribir código claro

## 🎯 Mis objetivos

- 💼 Conseguir mi primera oportunidad laboral como desarrollador backend
